...
public class Scene12 {
    //Scene 10 variable
    protected static Scene scene12;

    //Set scene 10
    protected static Scene setScene12(Stage window){
        //Set up scene4
        VBox layout = new VBox(20);
        layout.setAlignment(Pos.CENTER);
        //Labels
        Label warning = new Label("Unable to process deposit slip!");
        ...
        scene12 = new Scene(layout, Main.WIDTH, Main.HEIGHT);
        //Get style sheet
        scene12.getStylesheets().add("screen.css");
        return scene12;
    }

    //Get Scene 8 if it has already been set
    protected static Scene getScene12(){return scene12;}
}